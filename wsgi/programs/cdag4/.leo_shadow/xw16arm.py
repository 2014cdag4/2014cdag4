#@+leo-ver=4-thin
#@+node:kmolII_lite.20140610102829.1775:@shadow w16arm.py
import cherrypy
...
'''
    ...
    def assembly(self, *args, **kwargs):
        ...
        #@nonl
        #@<<script_begin>>
        #@+node:kmolII_lite.20140610102829.1776:<<script_begin>>
                <html>
                <head>
        ...
        #@nl
        #@        <<script>>
        #@+node:kmolII_lite.20140610102829.1777:<<script>>
        #@@language javascript
        /*設計一個零件組立函示
        get 組立
        get part
        ...
        */
        ...
        #@nl
        #@        <<script_end>>
        #@+node:kmolII_lite.20140610102829.1778:<<script_end>>
        </script>
        </body>
        </html>
        '''
