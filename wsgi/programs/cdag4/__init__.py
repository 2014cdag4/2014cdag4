...
class CDAG4(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDA 協同專案下的 cdag4 分組程式開發網頁, 以下為 W12 的任務執行內容.<br />
...
class RESUME5(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
這是 2014CDA 協同專案下的 cdag4 模組下的 RESUME5 類別.<br /><br />
<!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
<a href="assembly">執行  RESUME5 類別中的 assembly 方法</a><br /><br />
請確定下列零件於 V:/home/lego/man 目錄中, 且開啟空白 Creo 組立檔案.<br />
<a href="/static/lego_man.7z">lego_man.7z</a>(滑鼠右鍵存成 .7z 檔案)<br />
'''
        return outstring
